...
Base module for all entity-based game objects.
"""
...
class Entity(ABC):
    ...
    Provides:
    - Unique ID generation using class hierarchy prefixes
    - Position handling (x, y)
    - Runtime parameter validation
    - Enforcement of subclass structure requirements
    ...
    def __init__(self, **kwargs):
        """
        Initialize Entity instance with validated parameters.
    ...
    def position(self) -> list:
        """
        Return entity position as [x, y].

        Raises
        ------
        ValueError
            Raised when position is not fully initialized.
        """
    ...
    def __get_prefix_chain(cls: Type["Entity"]) -> list[str]:
        """
        Build inheritance-based prefix chain.

        Returns
        -------
        list[str]
            Ordered list of ID prefixes.
        """
        return [
    ...
    def __next_id(cls: Type["Entity"]) -> int:
        """
        Increment and return class-wide ID counter.
    ...
    def __check_parameters(given: dict[str, type], expected: dict[str, type]):
        ...
        ------
        ValueError
            Raised when invalid or unknown parameters are found.
        """
        for key in given:
